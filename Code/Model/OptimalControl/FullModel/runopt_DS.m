...
data = readtable('input_data/input_data_front_reach.csv');
...
OptSetup.N = nodes;
OptSetup.MaxIter = 500;	  % max number of iterations for the optimization
...
% Filename
filename = [folder_name '/front_reach'];
