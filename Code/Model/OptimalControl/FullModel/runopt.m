...
data = readtable('input_data/input_data_reach2mouth.csv');

% For mot files generated by Matlab (make_osimm.m) use importfile_mot
% data = importfile_mot('reach2mouth/originalmodel_5.mot');

% For mot files generated by Opensim use import_mot_osim
% data = importfile_mot_osim('kinematic_inputs/participant_ik.mot',dofnames);
...
% Set number of nodes
maxnodes = 80;		% end close to this number of nodes
...
folder_name = 'reach2mouth';
% Filename
filename = [folder_name '/originalmodel'];
