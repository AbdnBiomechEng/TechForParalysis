...
data_sim = load('high_reach/healthy_5');
...
OptSetup.model = 'simplified_model_struct_partC.mat';
...
OptSetup.initialguess = 'high_reach/healthy_5.mat';  % initial guess (see options in das3_optimize.m)
