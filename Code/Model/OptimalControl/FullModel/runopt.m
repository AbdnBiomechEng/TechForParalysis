...
%data = importfile_mot('equilibrium.mot'); 

% For mot files generated by Opensim use import_mot_osim
data = importfile_mot_osim('kinematic_inputs/ND20122_ik.mot',dofnames);
data = data(100:500,:); % choose only first arm elevation
