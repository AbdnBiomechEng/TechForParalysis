...
data = readtable('input_data/input_data_flexion.csv');
...
OptSetup.model = 'extended_workspace_model.mat';
...
% Set number of nodes
maxnodes = 6;		% end close to this number of nodes
...
if OptSetup.initial_state
    OptSetup.initialguess = 'small_range';
else
OptSetup.initialguess = 'init_dsem';  % initial guess (see options in das3_optimize.m)
end
