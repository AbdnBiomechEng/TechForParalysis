...
data = readtable('input_data_reach.csv');

% For mot files generated by Matlab (make_osimm.m) use importfile_mot
% data = importfile_mot('healthy/ND20126_input_20.mot');
% data_thor = load('healthy/ND20126_input_20');
...
folder_name = 'reach4';
% Filename
filename = [folder_name '/C5_notrack'];
