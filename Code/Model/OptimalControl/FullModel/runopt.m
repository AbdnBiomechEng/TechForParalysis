...
data = readtable('input_data/input_data_low_elev.csv');
...
% Set number of nodes
maxnodes = 3;		% end close to this number of nodes
...
OptSetup.initialguess = 'equilibrium';
